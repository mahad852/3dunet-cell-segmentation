...
def get_train_args():
    ...
    parser.add_argument("--is-regression", action="strore_true", help="is regression or segmentation")
    parser.add_argument("--is-mip", action="strore_true", help="use Max Intensity Projection (MIP)")
